      ...
      <div className="px-6 md:py-6 py-4 flex justify-between">
        ...
        <div className="w-0 flex-1">
          <div className="flex justify-between max-h-60 mt-1 space-x-2 text-xs">
            ...
            {isAnonymous||isCurrentUser || !user ? null : (
              <div className=" flex space-x-1 mr-5">
                ...
                <div
                  className="font-style-5-username text-blue-500 mt-[0.87rem] p-0 hover:underline cursor-pointer"
            ...
            <div className="font-style-4 mt-[11px]">{dateString}</div>
            {/* {formatTimeToNow(new Date(post.createdAt))} */}
          </div>
          {/* <a href={`/postPage/${post.id}`}> */}
            <h1 className="font-style-2 py-3 leading-6 dark:text-white">
              {post.title}
            </h1>
          {/* </a> */}
          ...
          >
            ...
            <p className="font-style-3 ProseMirror">{post.description ? parse(post.description) : ""}</p>
          ...
          (post.hashtags&&(Array.isArray(post.hashtags))&&(post.hashtags.length>0))&&
            <div className='font-style-4 mt-4'>
              {
      ...
      <div className=" dark:bg-[#1A1A1B]/65 rounded-b-2xl z-20 flex justify-between gap-x-3 text-sm px-4 py-4 sm:px-6">
        ...
        <div className=" flex gap-x-3">
          ...
          <button
            ...
            onClick={handleSave}
          >
            <Bookmark className={cn("h-4 w-4 font-style-4", {" text-black fill-black" : savedState == true,})} />{" "}
