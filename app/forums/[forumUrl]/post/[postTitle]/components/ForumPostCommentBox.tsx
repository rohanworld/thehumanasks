        ...
        {comments.map((comment, index) => (
          ...
          >
            <div className="flex  space-x-2">
              ...
              />
              <div>
                <p className="font-style-5-username text-sm font-semibold">{comment.name}</p>
                <p className="font-style-4 text-sm">{comment.comment}</p>
                <div>
                  <button
                        ...
                        {comment.replies && comment.replies.sort((a:any, b:any) => b.createdAt - a.createdAt).map((reply, replyIndex) => (
                          <div key={replyIndex} className="flex space-x-2 mt-2 ml-2">
                            ...
                            <div>
                              ...
                              <p className="font-style-4 text-sm">{reply.reply}</p>
                            </div>
                          </div>
                        ))}
                    </div>
